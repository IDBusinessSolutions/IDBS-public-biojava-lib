 ...
 *  
 *  The effect of these is to allow the BjLinearTrack component behave 
 ...
 * @author David Huen
 */
public abstract class BjLinearPanel
  extends
    JComponent
  implements
    SwingConstants,
    ...
    Changeable
{
  /**
	 * 
	 */
	private static final long serialVersionUID = -7123795352183106841L;
...
public static final ChangeType RENDERER = new ChangeType(
  ...
  /** Range which defines total extent of the sequence */
  ...
  public synchronized void paintComponent(Graphics g) {
          ...
          double maxAcross = sequenceToGraphics(range.getMax() + 1) + 1 +
  ...
  /** 
   * Obtain the left-most swing position of the specified sequence position.
   * The start of location 1 is at Swing coordinate 0. 
   */
  ...
  /**
   * Update the minimum, preferred and maximum sizes of this component
   */
  public void resizeAndValidate() {
      ...
      if(!isActive()) {
          ...
          double maxDropAcross = sequenceToGraphics(range.getMax());
  ...
  implements Serializable, SwingConstants {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 6995898970758495836L;
          ...
          implements SequenceRenderContext
  {
    ...
    public PaintContext() {
      this.range = (RangeLocation) LocationTools.intersection(
              BjLinearPanel.this.getRange(),
              new RangeLocation(1, BjLinearPanel.this.getSequence().length()));
    }
    ...
    public int getDirection()
    {
      return BjLinearPanel.this.getDirection();
    }

    public double getScale()
    {
      return BjLinearPanel.this.getScale();
    }

    public double sequenceToGraphics(int i)
    {
      return BjLinearPanel.this.sequenceToGraphics(i);
    }

    public int graphicsToSequence(double d)
    {
      return BjLinearPanel.this.graphicsToSequence(d);
    }

    public int graphicsToSequence(Point2D point)
    {
      return BjLinearPanel.this.graphicsToSequence(point);
    }

    public SymbolList getSymbols()
    {
      return BjLinearPanel.this.getSymbols();
    }

    public FeatureHolder getFeatures()
    {
      return BjLinearPanel.this.getFeatures();
    }

    public SequenceRenderContext.Border getLeadingBorder()
    {
      return BjLinearPanel.this.getLeadingBorder();
    }

    public SequenceRenderContext.Border getTrailingBorder()
    {
      return BjLinearPanel.this.getTrailingBorder();
    }

    public Font getFont()
    {
      return BjLinearPanel.this.getFont();
    }
  }
}
