 ...
 *  extended by BjGenbankFormat) and modified.
 *  
 *   However the BioJava class RichSequence continued to utilise the original 
 *   BioJava formats, due to the base classes containing static initializers 
 *   which register the base ahead of our new Blofeld extensions. The solution was 
 ...
 * @since 1.5
 */
public interface BjRichSequence extends BioEntry, Sequence {
